...
<div class="container mx-auto p-6">
    ...
    <div class="bg-white p-10 shadow-2xl rounded-xl mb-10 transform hover:scale-105 transition-transform duration-500">
        ...
        <form id="updateDrugDistributorForm" method="POST" action="/api/update-drug-distributor">
            <input type="text" name="drugId" placeholder="Drug ID" class="block w-full p-4 mb-6 border border-gray-400 rounded-lg focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-300">
            <input type="text" name="newDistributor" placeholder="New Distributor" class="block w-full p-4 mb-6 border border-gray-400 rounded-lg focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-300">
            <button type="submit" class="block w-full bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-4 rounded-lg hover:opacity-90 transition-opacity duration-300">
                Update Distributor
            </button>
        </form>
    </div>
    ...
    <div class="bg-white p-10 shadow-2xl rounded-xl transform hover:scale-105 transition-transform duration-500">
        ...
        <form id="verifyDrugForm" method="GET" action="/api/verify-drug">
            <input type="text" name="drugId" placeholder="Drug ID" class="block w-full p-4 mb-6 border border-gray-400 rounded-lg focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-300">
            <button type="submit" class="block w-full bg-gradient-to-r from-green-500 to-teal-500 text-white py-4 rounded-lg hover:opacity-90 transition-opacity duration-300">
                Verify Drug
            </button>
        </form>
    </div>
